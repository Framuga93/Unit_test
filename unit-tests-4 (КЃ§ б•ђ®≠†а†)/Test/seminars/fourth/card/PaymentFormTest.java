...
class PaymentFormTest {
    @Test
    void getCardHolderTest() {
        CreditCard creditCardMock = mock(CreditCard.class);

        when(creditCardMock.getCardHolder()).thenReturn("Card Holder");

        assertEquals(creditCardMock.getCardHolder(), "Card Holder");
    }
    ...
    void payTest() {
        ...
        verify(creditCardMock, times(1)).charge(25.5);
